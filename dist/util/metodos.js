...
exports.ordenarArray = exports.getNewId = exports.verObjId = void 0;
...
const verObjId = async (myArray, identify, tipoBusqueda) => {
...
const ordenarArray = async (myArray) => {
